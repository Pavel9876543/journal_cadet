...
Команда создаёт два самостоятельных демонстрационных года: архивный 2024/2025 и активный 2025/2026. В каждом основном классе создаётся не более трёх учеников, а ФИО архивного и активного наборов не повторяются. Оба года содержат группы, назначения, оценки, итоги и данные сдачи произведений; дополнительно создаются инструменты, партии оркестра, заявки и временные учётные данные.
